...
if st.button("Click here to Predict"):
    with st.spinner("Predicting..."):
        ...
        chart= alt.chart((comp_df).mark_bar().encode( x= 'x', y= 'y', tooltip= ['x', 'y', 'Model Prediction']))    
...
<div class="footer">
    <p>Made with ❤️ using Streamlit by Mihika Srivastava</p>
</div>
"""
